...
const CONFIG = {
  ...
  JOURNALS: [
    ...
    "Clinical and experimental allergy", "Clinical and Translational Immunology",
...
function saveResultsToSheet(data) {
  try {
    ...
    const fileName = `meta_rct_rev_mon_${formattedDate}`;
...
요약 시 주의사항:
  ...
  7. **질병 이름과 같은 의학 용어는 영어 그대로**, 저자는 1,2,3 저자 및 교신저자만, 이후는 et al 로 표시.  
...
• 🎯: <b>아토피 피부염의 병태생리학적 기전</b>에 대한 이해가 크게 향상되었으며, 이를 바탕으로 새로운 표적 치료법이 개발되어 치료 옵션이 혁신적으로 발전함
