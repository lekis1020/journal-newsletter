...
function sendSummariesToEmail(spreadsheet) {
  try {
    ...
    // 이메일 제목
    const emailSubject = `[Ajou Allergy Journal Letter] Respiratory disease (Asthma/Rhinitis/Sinusitis)`;
    ...
    emailBody += `<p>최근 1주일간 다음 저널에서 mesh Terms 을 이용해 asthma, rhinitis, sinusitis 에 대한 모든 논문의 초록을 요약합니다. <br> 
      J Allergy Clin Immunol, J Allergy Clin Immunol Pract, Allergy, Ann Allergy Asthma Immunol, Clin Exp Allergy, Allergol Int, World Allergy Organ J, NEJM Evid, NEJM, Chest, Lancet Respir Med, Am J Respir Crit Care Med, J Investig Allergol Clin Immunol, Allergy Asthma Proc, Allergy Asthma Clin Immunol, Frontiers in Immunology, Allergy Asthma Immunol Res, Allergy Asthma Respir Dis `;
